  ...
  return (
    ...
    className='fixed top-0 right-0 w-full md:w-375 h-screen bg-white drop-shadow-md flex flex-col z-[101]'>
        ...
        <div className='w-full flex items-center justify-between p-4 cursor-pointer'>
            <motion.div
            whileTap={{ scale : 0.5 }} onClick={showCart}>
                <MdOutlineKeyboardBackspace className='text-textColor text-3xl' />                
            </motion.div>

            <p className='text-indigo-800 text-lg font-semibold'>Cart</p>
                
            <motion.p whileTap={{ scale : 0.5 }} className='flex items-center gap-2 p-1 px-2 my-2 bg-gray-100 rounded-md hover:shadow-md cursor-pointer text-textColor text-base' onClick={clearCart}>Clear<RiRefreshLine /></motion.p>
           ...
           <div className='w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col'>
            ...
            <div className='w-full flex-1 bg-cartTotal rounded-t-[2rem] flex flex-col items-center justify-evenly px-8 py-2'>
                ...
                <div className='w-full flex items-center justify-between'>
                    ...
                    <p className='text-gray-200 text-xl font-semibold'>$ {tot + 0.9}</p>
                </div>
            ...
            <div className='w-full flex flex-col items-center justify-center gap-6'>
                ...
                <p className='text-xl text-indigo-600 font-semibold'>Add some items to your cart</p>
            </div>
        )}
