    ...
    <header className="fixed z-50 w-screen p-3 px-4 md:p-6 md:px-16 bg-primary border-b border-indigo-300">
      ...
      <div className="hidden md:flex w-full h-full items-center justify-between ">
        ...
        <div className="flex items-center gap-8">
          ...
          <div
            className="flex relative items-center justify-center gap-8"
            onClick={showCart}
          >
        ...
        <div className="relative flex gap-3">
          ...
          {isMenu && (
            ...
            >
              ...
              <p
                className="m-2 p-2 rounded-md shadow-md flex items-center justify-center bg-gray-200 gap-3 cursor-pointer hover:bg-gray-300 transition-all duration-100 ease-in-out text-indigo-600 text-base"
                onClick={logout}
              >
                Logout <MdLogout />
              </p>
